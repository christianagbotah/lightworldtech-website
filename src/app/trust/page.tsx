...
const defaultPractices = [
  {
    ...
    text: 'Administrative actions are protected by authenticated sessions, sensitive credentials are hashed, public endpoints are rate-limited where appropriate, and production builds are gated before release.',
  },
  {
