...
describe('verified award authority', () => {
  test('company profile uses exact publisher award categories', () => {
  ...
  test('public CMS defaults publish the same verified recognition facts', () => {
  ...
  test('assistant recognition answer uses specific sourced categories rather than generic award names alone', () => {
    const profile = source('src/lib/company-profile.ts');
