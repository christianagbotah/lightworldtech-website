  ...
  recognition: [
    {
      ...
      description: 'Lightworld Technologies Limited appears in the official 2021 winners directory.',
      href: 'https://meamarkets.digital/hall-of-fame/mea-business-awards-2021/',
    },
    {
      year: '2024',
      publisher: 'Acquisition International',
      title: 'Business Excellence Awards',
      description: 'Lightworld Technologies Limited appears in the official 2024 winners directory.',
      href: 'https://www.acquisition-international.com/hall-of-fame/business-excellence-awards-2024/',
    },
    {
      year: '2026',
      publisher: 'MEA Markets',
      title: 'African Excellence Awards',
      description: 'Lightworld Technologies Limited appears in the official 2026 winners directory.',
      href: 'https://meamarkets.digital/hall-of-fame/african-business-excellence-awards-2026/',
    },
  ],
  coverage: [
    {
