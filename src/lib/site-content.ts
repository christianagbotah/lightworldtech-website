...
export const cmsGroups: CmsGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'home_entity_summary', label: 'Company identity line', type: 'textarea', defaultValue: 'Lightworld Technologies Limited is a Ghanaian software and IT company based in Tema, Greater Accra, serving businesses and institutions in Ghana and beyond.' },
