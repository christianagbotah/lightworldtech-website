  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'trust_hero_description', label: 'Hero description', type: 'textarea', defaultValue: 'A practical view of how Lightworld approaches access control, privacy, reliable delivery and responsible AI across this website and our engineering process.' },
      {
        ...
        type: 'objectList',
        defaultValue: [
          { title: 'Access & application security', text: 'Administrative actions are protected by authenticated sessions, sensitive credentials are hashed, public endpoints are rate-limited where appropriate, and production builds are gated before release.' },
