...
export const cmsGroups: CmsGroup[] = [
  {
    ...
    fields: [
      { key: 'company_name', label: 'Company name', type: 'text', defaultValue: 'Lightworld Technologies Limited' },
      ...
      { key: 'company_phone1', label: 'Primary phone', type: 'text', defaultValue: '0243618186' },
      ...
      { key: 'header_company_link', label: 'Company menu landing link', type: 'url', defaultValue: '/about' },
      {
        ...
        type: 'objectList',
        defaultValue: [
          { title: 'Web & product engineering', desc: 'Websites, portals, SaaS and platforms', href: '/services/web-development', icon: 'code' },
          { title: 'Mobile apps', desc: 'Native-feeling iOS and Android experiences', href: '/services/mobile-app-development', icon: 'smartphone' },
          { title: 'Enterprise systems', desc: 'ERP, EAM, workflow and operational software', href: '/services/software-development', icon: 'workflow' },
          { title: 'AI & automation', desc: 'Assistive AI and intelligent workflows', href: '/services/ai-automation', icon: 'brain' },
          { title: 'Cloud & DevOps', desc: 'Deployment, reliability and infrastructure', href: '/services/cloud-devops', icon: 'cloud' },
          { title: 'Security engineering', desc: 'Secure architecture and application hardening', href: '/services/security-engineering', icon: 'shield' },
          { title: 'SEO & digital growth', desc: 'Search-ready architecture and analytics', href: '/services/seo-digital-performance', icon: 'search' },
          { title: 'Training & advisory', desc: 'IT skills, consulting and transformation', href: '/services/it-training', icon: 'graduation' },
        ],
        fields: [
  ...
  },
  {
    ...
    fields: [
      { key: 'home_eyebrow', label: 'Hero eyebrow', type: 'text', defaultValue: 'Lightworld Technologies Limited · Tema, Ghana' },
      { key: 'home_title', label: 'Hero title', type: 'textarea', defaultValue: 'Software, AI and digital systems built for real business.' },
      { key: 'home_description', label: 'Hero description', type: 'textarea', defaultValue: 'A Ghanaian software company and IT training institute designing websites, mobile apps, enterprise software, AI automation and cloud systems, with practical technology consulting and training.' },
      { key: 'home_entity_summary', label: 'Company identity line', type: 'textarea', defaultValue: 'Based in Tema, Greater Accra, Lightworld Technologies Limited serves businesses and institutions across Ghana and beyond.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cookie_banner_title', label: 'Cookie banner title', type: 'text', defaultValue: 'We value your privacy' },
      { key: 'cookie_banner_description', label: 'Cookie banner description', type: 'textarea', defaultValue: 'We use essential browser storage to operate the site. Optional analytics helps us understand consented website usage; optional categories stay off unless you choose them.' },
      ...
      { key: 'cookie_decline_label', label: 'Decline button label', type: 'text', defaultValue: 'Decline' },
      { key: 'cookie_accept_all_label', label: 'Accept-all button label', type: 'text', defaultValue: 'Accept All' },
      { key: 'cookie_save_preferences_label', label: 'Save-preferences button label', type: 'text', defaultValue: 'Save Preferences' },
      { key: 'cookie_categories_title', label: 'Cookie categories heading', type: 'text', defaultValue: 'Cookie Categories' },
      { key: 'cookie_always_on_label', label: 'Essential locked label', type: 'text', defaultValue: 'Always on' },
      ...
      { key: 'cookie_analytics_description', label: 'Analytics category description', type: 'textarea', defaultValue: 'Help us understand how visitors interact with our website.' },
      { key: 'cookie_marketing_name', label: 'Marketing category name', type: 'text', defaultValue: 'Marketing' },
      { key: 'cookie_marketing_description', label: 'Marketing category description', type: 'textarea', defaultValue: 'Reserved for optional marketing integrations. Not required for first-party website analytics.' },
      { key: 'cookie_preferences_name', label: 'Preferences category name', type: 'text', defaultValue: 'Preferences' },
  ...
  },
  {
    ...
    description: 'International positioning and remote-delivery messaging for organizations outside Ghana.',
    fields: [
      { key: 'global_hero_eyebrow', label: 'Global hero eyebrow', type: 'text', defaultValue: 'Ghana-built · global-ready' },
      { key: 'global_hero_title', label: 'Global hero title', type: 'textarea', defaultValue: 'A Ghanaian technology partner for ambitious teams anywhere.' },
      { key: 'global_hero_description', label: 'Global hero description', type: 'textarea', defaultValue: 'Lightworld Technologies Limited is headquartered in Tema, Ghana and can deliver software engineering, digital products, enterprise systems, AI-enabled workflows, cloud, security and advisory work for organizations that can collaborate with us remotely.' },
      { key: 'global_delivery_title', label: 'Delivery section title', type: 'text', defaultValue: 'A delivery model designed to travel well.' },
      { key: 'global_delivery_description', label: 'Delivery section description', type: 'textarea', defaultValue: 'Good international delivery depends less on distance than on clarity, accountability, secure systems and disciplined release practices. We organize the engagement around those fundamentals.' },
      { key: 'global_cta_title', label: 'Global CTA title', type: 'textarea', defaultValue: 'Your next technology partner does not have to be in the same city.' },
      { key: 'global_cta_description', label: 'Global CTA description', type: 'textarea', defaultValue: 'Tell us where your team is based, what you are trying to build or improve, and the working rhythm you need. We will tell you plainly whether Lightworld is a good fit.' },
    ],
  },
  {
    id: 'seo',
    ...
    fields: [
      { key: 'seo_home_title', label: 'Home title', type: 'text', defaultValue: 'Lightworld Technologies Limited | Software Company in Ghana' },
      { key: 'seo_home_description', label: 'Home description', type: 'textarea', defaultValue: 'Lightworld Technologies Limited is a Ghanaian software and IT company in Tema, Greater Accra, building websites, mobile apps, enterprise software, AI automation and cloud solutions, with IT training and technology consulting.' },
      { key: 'seo_about_title', label: 'About title', type: 'text', defaultValue: 'About Lightworld Technologies Limited' },
      { key: 'seo_global_title', label: 'Global delivery title', type: 'text', defaultValue: 'Global Software Engineering & Digital Transformation | Lightworld Technologies' },
      { key: 'seo_global_description', label: 'Global delivery description', type: 'textarea', defaultValue: 'Work with Ghana-based Lightworld Technologies for remote software engineering, web and mobile products, enterprise systems, AI automation, cloud, security and technology advisory.' },
      { key: 'seo_about_description', label: 'About description', type: 'textarea', defaultValue: 'Learn about Lightworld Technologies Limited, a Ghanaian software and IT company based in Tema, Greater Accra, building digital products, enterprise systems, AI workflows and cloud solutions.' },
      { key: 'seo_services_title', label: 'Services title', type: 'text', defaultValue: 'Software Development, Web & Mobile App Services in Ghana' },
      { key: 'seo_services_description', label: 'Services description', type: 'textarea', defaultValue: 'Explore software development, website development, mobile apps, enterprise systems, AI automation, cloud, cybersecurity, SEO, IT training and technology consulting from Lightworld Technologies in Ghana.' },
      { key: 'seo_products_title', label: 'Products title', type: 'text', defaultValue: 'Software Products & Business Platforms' },
      { key: 'seo_products_description', label: 'Products description', type: 'textarea', defaultValue: 'Discover software products, enterprise platforms and digital systems being developed by Lightworld Technologies for businesses, institutions and teams in Ghana and beyond.' },
      { key: 'seo_portfolio_title', label: 'Portfolio title', type: 'text', defaultValue: 'Software & Digital Product Portfolio in Ghana' },
      { key: 'seo_portfolio_description', label: 'Portfolio description', type: 'textarea', defaultValue: 'Explore web, mobile, enterprise software and digital product work designed and engineered by Lightworld Technologies in Ghana.' },
      { key: 'seo_team_title', label: 'Leadership title', type: 'text', defaultValue: 'Lightworld Technologies Leadership Team' },
      { key: 'seo_team_description', label: 'Leadership description', type: 'textarea', defaultValue: 'Meet the executive leadership of Lightworld Technologies Limited, the Ghanaian software and IT company.' },
      { key: 'seo_careers_title', label: 'Careers title', type: 'text', defaultValue: 'Technology Careers in Ghana' },
      { key: 'seo_careers_description', label: 'Careers description', type: 'textarea', defaultValue: 'Explore technology career opportunities in Ghana and ways to build ambitious software, web, mobile, AI and enterprise products with Lightworld Technologies.' },
      { key: 'seo_contact_title', label: 'Contact title', type: 'text', defaultValue: 'Contact Lightworld Technologies | Tema, Ghana' },
      { key: 'seo_contact_description', label: 'Contact description', type: 'textarea', defaultValue: 'Contact Lightworld Technologies in Tema, Greater Accra, Ghana for website development, mobile apps, enterprise software, AI automation, cloud projects, IT training and technology consulting.' },
      { key: 'seo_blog_title', label: 'Insights title', type: 'text', defaultValue: 'Technology & Software Insights from Ghana' },
      { key: 'seo_blog_description', label: 'Insights description', type: 'textarea', defaultValue: 'Practical insights from Lightworld Technologies in Ghana on software development, web and mobile products, enterprise systems, AI, cloud and digital transformation.' },
      ...
      { key: 'seo_trust_title', label: 'Trust Center title', type: 'text', defaultValue: 'Security, Privacy & Responsible AI | Lightworld Technologies' },
      { key: 'seo_trust_description', label: 'Trust Center description', type: 'textarea', defaultValue: 'Review Lightworld Technologies Limited security, privacy, reliable-delivery and responsible-AI practices for its website and software engineering work.' },
      { key: 'seo_newsroom_title', label: 'Newsroom title', type: 'text', defaultValue: 'Lightworld Technologies Awards, News & Company Facts' },
      { key: 'seo_newsroom_description', label: 'Newsroom description', type: 'textarea', defaultValue: 'Verified company facts, award recognition, press coverage, leadership information and public updates about Lightworld Technologies Limited in Ghana.' },
    ],
  },
];
