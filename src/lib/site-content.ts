...
export const cmsGroups: CmsGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cookie_accept_label', label: 'Accept button label', type: 'text', defaultValue: 'Accept current optional' },
      ...
      { key: 'cookie_preferences_description', label: 'Preferences category description', type: 'textarea', defaultValue: 'Allow the website to remember optional experience choices you make.' },
