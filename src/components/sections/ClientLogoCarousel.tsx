      ...
      <div className="relative mb-4">
        ...
        >
          {allLogos.slice(0, 12).map((logo, i) => (
            <div
              key={`row1-${i}`}
              className="flex-shrink-0 flex items-center gap-2.5 px-5 py-3 rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/50 hover:border-amber-300 dark:hover:border-amber-500/50 transition-all duration-300 group cursor-default"
            >
