      ...
      <div className="container-main relative z-10 pt-8 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-gradient bg-gradient-to-r from-amber-300 via-amber-400 to-amber-600 bg-clip-text text-transparent drop-shadow-lg">
              Possibilities
            </span>
          </motion.h1>
          ...
          >
            ...
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-600 via-amber-400 to-amber-300 rounded-lg opacity-60 group-hover:opacity-100 blur-sm transition-opacity duration-500 animate-glow-pulse" />
              <Button
