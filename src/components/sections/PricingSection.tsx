                      ...
                      className={`w-full mb-6 transition-all duration-300 group/btn ${
                        tier.popular
                          ...
                          : isEnterprise
                            ...
                            : 'border-amber-200 dark:border-amber-500 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30 hover:border-amber-300 dark:hover:border-amber-500'
                      }`}
