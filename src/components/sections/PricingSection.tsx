  ...
  return (
    <section id="pricing" className="section-padding bg-slate-50 dark:bg-slate-800/50 relative overflow-hidden">
      ...
      <div className="container-main relative z-10">
        ...
        >
          <Badge className="bg-amber-100 dark:bg-amber-900/40 text-amber-500 dark:text-amber-300 border-amber-200 dark:border-amber-500 mb-4 backdrop-blur-sm">
                  ...
                  className={`relative h-full overflow-hidden transition-all duration-500 group shimmer-sweep ${
                    tier.popular
                      ...
                      : isEnterprise
                        ...
                        : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 backdrop-blur-sm hover:border-amber-300 dark:hover:border-amber-500 hover:shadow-xl dark:hover:shadow-amber-900/20 hover:-translate-y-2 hover:scale-[1.02]'
                  }`}
                >
                  ...
                  {isEnterprise && (
                    <div className="absolute inset-0 rounded-2xl p-[2px] overflow-hidden pointer-events-none">
                      <div className="absolute inset-0 bg-gradient-to-r from-amber-600 via-amber-400 to-amber-600 animate-gradient-shift opacity-60 group-hover:opacity-100 transition-opacity duration-500" style={{
                  ...
                  <CardContent className="p-6 sm:p-8 flex flex-col h-full relative z-10">
                    ...
                    <div className="mb-6">
                      ...
                      >
                        <Icon className={`size-6 transition-all duration-300 ${tier.popular || isEnterprise ? 'text-white' : 'text-amber-600 dark:text-amber-300 group-hover:text-white group-hover:rotate-6'}`} />
                      </div>
                    ...
                    <Button
                      ...
                      className={`w-full mb-6 transition-all duration-300 group/btn ${
                        tier.popular
                          ? 'bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white shadow-lg shadow-amber-500/25 hover:shadow-xl hover:shadow-amber-500/30 h-11'
                          : isEnterprise
                            ? 'bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white shadow-lg shadow-amber-500/25 hover:shadow-xl h-11'
                            : 'border-amber-200 dark:border-amber-500 text-amber-600 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/30 hover:border-amber-300 dark:hover:border-amber-500'
                      }`}
        ...
        >
          ...
          <button
            ...
            className="text-amber-600 dark:text-amber-300 hover:underline font-medium underline-offset-2"
          >
            Contact us
          </button>{' '}
          for details.
