        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="mt-4 h-1.5 rounded-full bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 opacity-60" />
            </motion.div>

            {/* Right: Process steps with timeline */}
            <div className="relative">
              {/* Vertical timeline connector line */}
              <div className="absolute left-[1.3rem] top-4 bottom-4 w-[2px] bg-gradient-to-b from-amber-400/30 via-amber-400/20 to-amber-400/30 rounded-full hidden lg:block" />
              {/* Glow dot at top of timeline */}
              <div className="absolute left-[1.1rem] top-2 size-[6px] rounded-full bg-amber-400/50 blur-[2px] hidden lg:block" />
              ...
              {steps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div className="p-5 rounded-xl bg-white dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200/80 dark:border-slate-700/50 shadow-sm hover:shadow-2xl hover:shadow-amber-500/5 dark:hover:shadow-amber-900/20 hover:border-amber-300 dark:hover:border-amber-500/50 transition-all duration-500 h-full hover:-translate-y-1.5 group relative overflow-hidden hover:scale-[1.02]">
                      ...
                      <div className="flex items-center gap-4 mb-3 relative">
                        ...
                        >
                          <div className="absolute inset-0 rounded-full bg-gradient-to-br from-amber-400/30 to-amber-400/30 animate-pulse" />
                          <div className="relative size-12 rounded-full bg-gradient-to-br from-amber-500 via-amber-600 to-amber-500 dark:from-amber-400 dark:via-amber-500 dark:to-amber-400 flex items-center justify-center text-white font-bold text-base shadow-lg shadow-amber-500/30 dark:shadow-amber-900/40 ring-2 ring-white/60 dark:ring-slate-700/60">
                            {step.number || index + 1}
                          </div>
                        </motion.div>
                        <div className="size-10 rounded-xl bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-900/40 dark:to-amber-900/20 flex items-center justify-center group-hover:shadow-md transition-all duration-500">
                          <IconComp className="size-5 text-amber-600 dark:text-amber-400 group-hover:text-amber-500 dark:group-hover:text-amber-400 group-hover:scale-110 transition-all duration-500" />
                        </div>
                      </div>

                      <h3 className="font-semibold text-sm mb-1.5 text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300">{step.title}</h3>
