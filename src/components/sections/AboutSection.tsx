        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <Button
              ...
              className="bg-amber-600 hover:bg-amber-500 dark:bg-amber-400 dark:hover:bg-amber-300 text-white dark:text-slate-950 shadow-md hover:shadow-lg transition-shadow"
            >
              Learn More About Us
          ...
          >
            ...
            <div className="absolute -inset-[3px] rounded-2xl bg-gradient-to-br from-amber-300 via-amber-500 to-amber-700 opacity-75 blur-[1px]" />
            <motion.div
