                    ...
                    >
                      ...
                      <CardContent className="p-5">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed line-clamp-3 mb-3 relative">
                          <Quote className="size-4 text-amber-300 dark:text-amber-400 absolute -top-0.5 -left-0.5 opacity-50" />
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-start gap-3 mb-5 relative">
                  ...
                  <Quote className="size-8 text-amber-300 dark:text-amber-400 shrink-0 mt-1 relative" />
