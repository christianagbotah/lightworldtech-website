      ...
      <header className="lw-hero-grid border-b border-slate-200/70 dark:border-white/[0.06]">
        <div className="container-main py-12 sm:py-16 lg:py-20">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="mt-8 max-w-5xl">
            <span className="inline-flex rounded-full bg-amber-500/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-amber-700 dark:text-amber-300">
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-slate-400 dark:text-white/25">
              ...
              <button onClick={share} className="inline-flex items-center gap-1.5 font-medium text-amber-700 transition hover:text-amber-600 dark:text-amber-300">
      ...
      <div className="container-main py-10 sm:py-14 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_240px] lg:gap-16">
          <div className="min-w-0">
            <div className="lw-article prose prose-slate max-w-none dark:prose-invert prose-headings:tracking-[-0.025em] prose-p:leading-8 prose-a:text-amber-600 dark:prose-a:text-amber-300 prose-img:rounded-2xl">
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-28 rounded-[24px] border border-slate-200/70 bg-white p-5 dark:border-white/[0.07] dark:bg-white/[0.025]">
              ...
              <button onClick={share} className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 px-4 py-2.5 text-xs font-semibold text-slate-600 transition hover:border-amber-300 hover:text-amber-700 dark:border-white/[0.08] dark:text-white/45">
