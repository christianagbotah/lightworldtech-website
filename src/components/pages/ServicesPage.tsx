        ...
        <div className="container-main">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {serviceItems.map((service, index) => (
              <motion.button
                ...
                className={
                  active === service.id
                    ? 'group rounded-[26px] border border-amber-400/35 bg-amber-500/[0.08] p-5 text-left shadow-lg shadow-amber-950/[0.04] dark:bg-amber-300/[0.055]'
                    : 'group rounded-[26px] border border-slate-200/75 bg-white p-5 text-left transition hover:-translate-y-0.5 hover:border-amber-300/50 dark:border-white/[0.07] dark:bg-white/[0.025] dark:hover:bg-white/[0.04]'
                }
              ...
              >
                ...
                <p className="mt-6 text-[9px] font-semibold uppercase tracking-[0.18em] text-amber-600/70 dark:text-amber-300/55">{service.eyebrow}</p>
          ...
          >
            <div className="border-b border-slate-200/70 p-6 sm:p-8 lg:border-b-0 lg:border-r dark:border-white/[0.06]">
              ...
              <p className="mt-7 text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-600 dark:text-amber-400">{selected.eyebrow}</p>
      ...
      <section className="section-padding">
        <div className="container-main">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-amber-600 dark:text-amber-400">Engagement model</p>
