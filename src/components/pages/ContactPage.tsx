      ...
      <section className="lw-hero-grid relative border-b border-slate-200/70 dark:border-white/[0.06] overflow-hidden">
        ...
        <div className="relative container-main py-16 sm:py-20 lg:py-24 z-10">
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="grid gap-9 lg:grid-cols-[1.05fr_.95fr] lg:items-end">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/[0.08] px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-700 dark:text-amber-300">
                  ...
                  <form onSubmit={submit} className="mt-7 space-y-5">
                    <div className="grid gap-4 sm:grid-cols-2">
                      <label className="space-y-2 text-xs font-medium text-slate-500 dark:text-white/35">
                        ...
                        <input
                          ...
                          className="h-11 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-900 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-500/15 dark:border-white/[0.07] dark:bg-white/[0.03] dark:text-white"
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <label className="space-y-2 text-xs font-medium text-slate-500 dark:text-white/35">
                        ...
                        <select
                          ...
                          className="h-11 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-900 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-500/15 dark:border-white/[0.07] dark:bg-[#0c141b] dark:text-white"
                        >
                    ...
                    <label className="block space-y-2 text-xs font-medium text-slate-500 dark:text-white/35">
                      ...
                      <textarea
                        ...
                        rows={7}
                        className="w-full resize-y rounded-[22px] border border-slate-200 bg-slate-50 px-4 py-3 text-sm leading-6 text-slate-900 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-500/15 dark:border-white/[0.07] dark:bg-white/[0.03] dark:text-white"
