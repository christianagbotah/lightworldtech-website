        ...
        <div className={`relative p-5 ${info?.popular ? 'bg-gradient-to-r from-amber-500 to-amber-600 dark:from-amber-600 dark:to-amber-500' : 'bg-slate-100 dark:bg-slate-800'}`}>
          <div className="flex items-center gap-3">
            <div className={`size-10 rounded-lg flex items-center justify-center ${info?.popular ? 'bg-white/20' : 'bg-white dark:bg-slate-700'}`}>
              <IconComp className={`size-5 ${info?.popular ? 'text-white' : 'text-amber-600 dark:text-amber-300'}`} />
            </div>
  ...
  return (
    <section className="section-padding bg-white dark:bg-slate-900">
      <div className="container-main">
        ...
        >
          <span className="text-sm font-semibold text-amber-600 dark:text-amber-300 uppercase tracking-wider">Compare</span>
          <h2 className="text-3xl sm:text-4xl font-bold mt-2 mb-4 text-slate-900 dark:text-white">
            Service <span className="text-amber-600 dark:text-amber-300">Comparison</span>
          </h2>
                  ...
                  <table className="w-full min-w-[600px] border-collapse">
                    <thead>
                      <tr>
                        ...
                        <th className="text-center py-4 px-4 border-b-2 border-amber-300 dark:border-amber-500 relative">
                      ...
                      {comparisonData.map((row, index) => {
                        ...
                        return (
                          <motion.tr
                            ...
                            className={`group transition-colors ${isDiff ? 'bg-amber-50/40 dark:bg-amber-900/5 hover:bg-amber-50/80 dark:hover:bg-amber-900/10' : 'hover:bg-amber-50/60 dark:hover:bg-amber-900/10'}`}
                          >
        ...
        >
          ...
          <Button className="bg-amber-600 hover:bg-amber-500 text-white shadow-md hover:shadow-lg transition-all duration-300">
