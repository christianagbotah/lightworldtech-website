...
const navItems = [
  ...
  { id: 'leads', label: 'Leads CRM', icon: Target, page: 'admin-leads' as const },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const handleNavClick = (id: string, page: 'admin-dashboard' | 'admin-pages' | 'admin-services' | 'admin-blog' | 'admin-blog-editor' | 'admin-team' | 'admin-testimonials' | 'admin-leads' | 'admin-messages' | 'admin-settings' | 'admin-faqs' | 'admin-portfolio') => {
    setAdminTab(id);
    navigate(page);
