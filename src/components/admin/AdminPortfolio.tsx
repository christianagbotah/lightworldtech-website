              ...
              {projects.length === 0 ? (
                ...
                projects.map((p) => (
                  <TableRow key={p.id}>
                    ...
                    <TableCell className="text-center">
                      <Badge className={p.active ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400'}>
