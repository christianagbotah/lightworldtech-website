      ...
      <div className="container-main relative py-14 sm:py-16 lg:py-20">
          ...
          <div className="max-w-2xl">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <span>
                ...
                <span className="mt-1 block text-[9px] font-semibold uppercase tracking-[0.24em] text-amber-300/75">{tagline}</span>
              </span>
            </Link>
        ...
        <div className="mt-10 flex flex-col gap-5 border-t border-white/[0.07] pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <FooterNavLink
              href={footerCtaLink}
              className="ml-1 inline-flex h-9 items-center gap-1.5 rounded-full bg-white px-4 text-xs font-semibold text-slate-950 transition hover:bg-amber-300"
            >
