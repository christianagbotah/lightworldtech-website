          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                {/* Button background */}
                <div className="size-11 rounded-full bg-amber-500 hover:bg-amber-600 text-white shadow-lg hover:shadow-xl flex items-center justify-center transition-colors">
