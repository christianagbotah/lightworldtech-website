        ...
        <>
          ...
          >
            <div className="relative w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
              {/* Gradient Header */}
              <div className="relative bg-gradient-to-br from-amber-600 via-amber-500 to-amber-500 p-8 pb-12">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-amber-300/10 rounded-full blur-3xl" />
                  ...
                  {!success ? (
                    <div className="relative z-10">
                      ...
                      <form onSubmit={handleSubscribe} className="space-y-3">
                        ...
                        <Button
                          type="submit"
                          className="w-full h-11 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-shadow duration-300"
                          disabled={loading}
                        >
                          {loading ? (
                    ...
                    <div className="text-center py-4 relative z-10">
                      ...
                      >
                        <Button
                          onClick={handleClose}
                          className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white shadow-lg shadow-amber-500/25"
                        >
                          Continue Browsing
                        </Button>
                      </motion.div>
