...
# PostgreSQL is an external production service. Never bundle a database file
# or production database credentials into the application artifact.
echo "🗄️  PostgreSQL 使用外部数据库；构建产物不会打包数据库文件"
