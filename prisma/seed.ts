...
async function seed() {
  ...
  const settings = [
    ...
    { key: 'company_phone1', value: '0243618186', type: 'text', group: 'contact' },
  ...
  const services = [
    {
      ...
      features: JSON.stringify([
        ...
        'Web applications and SaaS interfaces',
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        'Technical mentoring and workshops',
    ...
    },
    {
      ...
      features: JSON.stringify([
        'Technical SEO',
        'Search-focused information architecture',
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        'Enterprise asset and maintenance systems',
        'CRM and service workflows',
        'School and institutional systems',
    ...
    },
    {
      ...
      features: JSON.stringify([
        ...
        'Backups and recovery foundations',
        'Monitoring and health checks',
        'Deployment and reliability support',
      ]),
      order: 5,
    },
  ];
